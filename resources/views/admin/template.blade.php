...
<style type="text/css">
    ...
    @media (min-width: 768px) {
        #main-wrapper[data-sidebartype=mini-sidebar] .sidebar-item {
            position: relative;
        }

        #main-wrapper[data-sidebartype=mini-sidebar] .sidebar-item:hover .hide-menu {
        ...
        #main-wrapper[data-sidebartype=mini-sidebar] .sidebar-item:hover {
            background: #f8f9fa;
        }
    }
</style>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header d-flex align-items-center justify-content-between px-3" data-logobg="skin6">
                    <!-- Mobile Toggler - Left Side (GitHub Style) -->
                    <a class="nav-toggler waves-effect waves-light text-dark d-block me-2" href="javascript:void(0)"><i
                            class="fas fa-bars fs-5"></i></a>
                    <!-- ============================================================== -->
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    ...
                    <div class="d-block" style="width: 24px;"></div>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('admin.bagian.index') }}" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('admin.produk.index') }}" aria-expanded="false">
                                <i class="fas fa-boxes-stacked me-3" aria-hidden="true"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('admin.transaksi') }}" aria-expanded="false">
                                <i class="fas fa-boxes-stacked me-3" aria-hidden="true"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('admin.waiters.index') }}" aria-expanded="false">
                                <i class="fas fa-boxes-stacked me-3" aria-hidden="true"></i>
                                <span class="hide-menu">Waiters</span>
                            </a>
                        </li>
                        {{-- <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('admin.galeri.index') }}" aria-expanded="false">
                                <i class="fas fa-images me-3" aria-hidden="true"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('admin.website') }}" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link text-black" href="#"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="fas fa-lock-open me-3 text-black"></i>
    ...
    <script>
        $(function () {
            $(".nav-toggler").on("click", function () {
                ...
                var currentType = wrapper.attr("data-sidebartype");
